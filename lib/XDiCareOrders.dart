...
class XDiCareOrders extends StatelessWidget {
  XDiCareOrders({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_2zz37w =
    '<svg viewBox="32.5 346.5 292.0 1.0" ><path transform="translate(32.5, 346.5)" d="M 0 0 L 292 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
