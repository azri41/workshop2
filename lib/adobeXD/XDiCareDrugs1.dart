...
class XDiCareDrugs1 extends StatelessWidget {
  XDiCareDrugs1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(44.0, 211.0),
            child:
                // Adobe XD layer: 'Paracetamol' (shape)
                Container(
              width: 72.5,
              height: 100.0,
              decoration: BoxDecoration(
          ...
          Transform.translate(
            offset: Offset(105.0, 320.0),
            child:
                // Adobe XD layer: 'add_circle-24px' (group)
                SizedBox(
              width: 24.0,
              height: 24.0,
              child: Stack(
          ...
          Transform.translate(
            offset: Offset(29.0, 320.0),
            child:
                // Adobe XD layer: 'remove_circle-24px' (group)
                SizedBox(
              width: 24.0,
              height: 24.0,
              child: Stack(
...
const String _svg_j2wt9q =
    '<svg viewBox="2.0 2.0 20.0 20.0" ><path  d="M 12 2 C 6.480000019073486 2 2 6.480000019073486 2 12 C 2 17.52000045776367 6.480000019073486 22 12 22 C 17.52000045776367 22 22 17.52000045776367 22 12 C 22 6.479999542236328 17.52000045776367 2 12 2 Z M 17 13 L 13 13 L 13 17 L 11 17 L 11 13 L 7 13 L 7 11 L 11 11 L 11 7 L 13 7 L 13 11 L 17 11 L 17 13 Z" fill="#000000" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_s61pi2 =
    '<svg viewBox="2.0 2.0 20.0 20.0" ><path  d="M 12 2 C 6.480000019073486 2 2 6.480000019073486 2 12 C 2 17.52000045776367 6.480000019073486 22 12 22 C 17.52000045776367 22 22 17.52000045776367 22 12 C 22 6.479999542236328 17.52000045776367 2 12 2 Z M 17 13 L 7 13 L 7 11 L 17 11 L 17 13 Z" fill="#000000" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
