...
class XDiCareResult extends StatelessWidget {
  XDiCareResult({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(57.0, 232.0),
            child: SizedBox(
              width: 266.0,
              height: 285.0,
              child: Text(
                'Currently you are having fever. Please do an appointment with your doctor if your fever not been settled.',
                style: TextStyle(
                  fontFamily: 'Calibri',
                  fontSize: 20,
                  color: const Color(0xff000000),
